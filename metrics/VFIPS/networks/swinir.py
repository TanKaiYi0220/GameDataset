...
# remove conv layer and skip connection
...
# from swin IR
# we remove the normalization layer
class SwinDiffTiny(nn.Module):
    ...
    def __init__(self, in_chans=3, out_chans=64, embed_dim=180, depths=[3,], num_heads=[3,], window_size=8, mlp_ratio=2., ):
        super(SwinDiffTiny, self).__init__()
