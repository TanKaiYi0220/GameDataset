...
def main():
    ...
    parser.add_argument("--output_dir", default="./output/IFRNet_Residual_WarpBiDir_540p/", type=str)
    parser.add_argument("--resume_path", default=None, type=str)
    # parser.add_argument("--resume_path", default="./output/IFRNet_Residual_WarpBiDirDifficult_MERGED/checkpoints/IFRNet/merged_fps60_Difficult/best.pth", type=str)
